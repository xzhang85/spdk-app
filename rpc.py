...
if __name__ == "__main__":
    ...
    def device_init(args):
        print_dict(rpc.own.device_init(args.client, bdev_name=args.bdev_name))

    p = subparsers.add_parser('device_init', help='')
    p.add_argument('-d', '--bdev_name', help='bdev name to init')
    p.set_defaults(func=device_init)

    def device_exit(args):
        print_dict(rpc.own.device_exit(args.client, bdev_name=args.bdev_name))

    p = subparsers.add_parser('device_exit', help='')
